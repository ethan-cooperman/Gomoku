...
class Button:
    ...
    def __init__(self, window, pathway: str, x, y, width = None, height = None, hover_pathway = None):
        ...
        if not width and not height and hover_pathway:
            ...
            self.image = pygame.transform.scale(pygame.image.load(pathway), (width, height))
            self.hover_image = pygame.transform.scale(pygame.image.load(hover_pathway), (width, height))
